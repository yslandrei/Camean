...
export default function ReviewCard(props: { review: reviewType, setIsDimmed: Function }) {

  function handleReadMore() {
    props.setIsDimmed(true)
  }

  return (
    <>
      <div onClick={handleReadMore} className='w-1/2 mt-10 h-[140px] cursor-pointer'>
